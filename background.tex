...
The \li{raise} clause of the handler is \li{resume\ 3} , which tells the program to continue evaluate but use 3 as the result of the operation. So the final result for the whole expression is 5. This example shows the algebraic effects a more structured form of delimited continuations. 

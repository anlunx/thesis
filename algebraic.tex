...
\todo[inline]{TODO: make the example readable}
\begin{lstlisting}
...
val var = 
  < read $\hookrightarrow$ $\lambda$x:Unit. get((); y.return y),
    ...
    handle $\hookrightarrow$  $\lambda$c: Unit $\rightarrow$ Int. (with hstate handle c ()) 0 >
\end{lstlisting}
